...
void ofApp::setup() {
    ...
    formulaPart1.load("formula_part1.png");
    formulaPart2.load("formula_part2.png");
    formulaFull.load("formula_full.png");
}
...
void ofApp::draw() {
    ...
    if (animationTime < 3.0f) {
        ...
        if (tickTime < 2.0f) {
            ...
            // Draw epsilon rectangle and update points
            if (numPoints >= 5) {
            ...
            // Draw the appropriate formula image based on animation stage
            if (numPoints >= 10) {
